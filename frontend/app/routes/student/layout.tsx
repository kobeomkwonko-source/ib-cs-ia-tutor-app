      ...
      <header className="border-b bg-gray-50 px-4 py-3">
        <div className="mx-auto flex max-w-4xl items-center justify-between">
          ...
          <nav className="flex items-center gap-2 text-sm">
            <NavButton to="/student/dashboard">Dashboard</NavButton>
            <NavButton to="/student/login">Student Login</NavButton>
            <NavButton to="/student/register">Student Register</NavButton>
          </nav>
        </div>
      </header>
